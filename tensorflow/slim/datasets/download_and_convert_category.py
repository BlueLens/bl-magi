...
def _get_filenames_and_classes(dataset_dir):
  ...
  """
  category_root = os.path.join(dataset_dir, 'images')
  directories = []
  class_names = []

  for filename in os.listdir(category_root):
    path = os.path.join(category_root, filename)
...
def _get_dataset_filename(dataset_dir, split_name, shard_id):
  output_filename = 'category_%s_%05d-of-%05d.tfrecord' % (
...
def run(dataset_dir):
  ...
  print('\nFinished converting the Categories dataset!')
