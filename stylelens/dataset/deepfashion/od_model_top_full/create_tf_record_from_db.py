...
def read_from_db(dataset_api, category_class):
  ...
  if category_class == str(3):
    cut_idx = 22454
    train_images = valid_images[0:cut_idx]
    eval_images = valid_images[cut_idx:-1]
    print(cut_idx)
  else:
    cut_idx = 48000
    train_images = valid_images[0:cut_idx]
    eval_images = valid_images[cut_idx:60001]
...
def main(_):
  ...
  # top / full 
  category_class = str(1)
  print(category_class)
  (category_train_images, category_eval_images) = read_from_db(dataset_api,category_class)
